#!/bin/bash
CONTROL_PLANE_IP="192.168.4.94"
ADDITIONAL_CONTROL_PLANE_NODES=("192.168.4.95" "192.168.4.71")
WORKER_IP=("192.168.4.96" "192.168.4.73" "192.168.4.72" "192.168.4.81" "192.168.4.97")
...
# ENSURE AT THIS POINT THAT THE CONTROLPLANE AND WORKER CONFIGS CONTAIN THE NETWORK INTERFACE SETTINGS
# THAT YOU WANT. THE SPECIFIC VALUES WILL BE REPLACED LATER BASED ON THE ACTUAL MAC ADDRESSES
