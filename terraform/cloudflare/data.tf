# Pull project ID, projects subzone name, and the CF API / tunnel token GSM
# secret IDs from terraform/gcp state. This root creates Cloudflare-side
# resources; terraform/gcp owns the GSM containers those resources read
# from and write to.
...
locals {
  ...
  projects_dns_name                 = data.terraform_remote_state.gcp.outputs.projects_dns_name
